...
# This file is copied from https://github.com/rails/rails/blob/main/actionmailbox/lib/action_mailbox/relayer.rb with minimal modifications
...
module ActionMailbox
  class Relayer
    ...
    USER_AGENT   = "action-mailbox-docker-relay v#{ActionMailboxDockerRelay.version} https://github.com/bb/action-mailbox-docker-relay"
